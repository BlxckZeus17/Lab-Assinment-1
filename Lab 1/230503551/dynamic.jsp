...
<head>
  <meta charset="utf-8">
  <title>230503551 — Dynamic JSP Page</title>
...
<body>
  <div class="box">
    ...
    <p>The current server date is: 
      <strong><%= new java.text.SimpleDateFormat("EEEE, dd MMMM yyyy").format(new java.util.Date()) %></strong>
    </p>
    <p>The current server time is: 
      <strong><%= new java.text.SimpleDateFormat("hh:mm:ss a").format(new java.util.Date()) %></strong>
    </p>
